...
#define kfifo_in_locked(a,b,c,d) kfifo_put(a,b,c)
#define kfifo_out_locked(a,b,c,d) kfifo_get(a,b,c)
...
static void gsm_dtr_rts(struct tty_port *port)
{
	struct gsm_dlci *dlci = container_of(port, struct gsm_dlci, port);
...
static int gsmtty_open(struct tty_struct *tty, struct file *filp)
{
	...
	set_bit(ASYNC_INITIALIZED, &port->flags);
